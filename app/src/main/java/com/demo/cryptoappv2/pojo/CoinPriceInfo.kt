...
import com.demo.cryptoappv2.api.ApiFactory.BASE_IMAGE_URL
import com.demo.cryptoappv2.utils.convertTimestampToTime
...
data class CoinPriceInfo(
    ...
    fun getFullImgUrl(): String = BASE_IMAGE_URL + imageUrl
}